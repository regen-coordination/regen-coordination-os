...
| Fund | Node | Chain | Spinach | Status |
|------|------|-------|---------|--------|
| NYC Garden Pool | nyc-node | Gnosis | yes | active |
| GreenPill Dev Guild Treasury Kit | greenpill-network | Gnosis | yes (UberSwap: 10% USDC + OOBA) | active |

---

## Octant / Impact Stake Vaults
...
- `data/funds.yaml` — machine-readable registry
- `skills/funding-scout/` — track balances and distributions
- `skills/capital-flow/` — queue transactions to Safe treasuries
